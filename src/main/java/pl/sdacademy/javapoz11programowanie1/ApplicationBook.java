...
import pl.sdacademy.javapoz11programowanie1.books.Nation;
...
public class ApplicationBook {
    public static void main(String[] args) {
        ...
        System.out.println("średnia liczba stron: ");
        ...
        findBookByAuthor(books, authors.get(3));

    }

    public static void  findBookByAuthor(List<Book> books, Author author){
        books.stream()
